...
export class start_ani
{
    ...
    constructor()
    {
        ...
        addEventListener('mousedown',this.onDown.bind(this),false);
        addEventListener('mousemove',this.onMove.bind(this),false);
        addEventListener('mouseup',this.onUp.bind(this),false);
    }
